...
typedef enum {
    ...
    XML_XPATH_SATISFIABILITY_AXIS_NOT_TREATED, /* 1251 */
    XML_XPATH_SATISFIABILITY_NO_NODE, /* 1252 */
    XML_XPATH_SATISFIABILITY_NOT_IMPLEMENTED, /* 1253 */
    ...
    XML_SCHEMAV_XPATHV_VERTICAL_MODEL_FAILURE, /* 1891 */
